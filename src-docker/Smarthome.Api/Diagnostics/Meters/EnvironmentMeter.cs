...
namespace Smarthome.AmbientCollector.Api.Diagnostics.Meters
{
	public static class EnvironmentMeter
	{
		...
		static EnvironmentMeter()
		{
			...
			_temperatureGauge = _meter.CreateGauge<double>( "envsensor.temperature", "degC", "Current temperature in Celsius" );
			_humidityGauge = _meter.CreateGauge<double>( "envsensor.humidity", "%", "Current humidity in %" );
			_pressureGauge = _meter.CreateGauge<double>( "envsensor.pressure", "hPa", "Current ambient pressure in hPa" );
		}
