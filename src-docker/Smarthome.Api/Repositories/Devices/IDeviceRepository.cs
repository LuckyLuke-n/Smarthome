...
namespace Smarthome.Api.Repositories.Devices
{
	public interface IDeviceRepository
	{
		...
		Task<RepositoryResponse<IEnumerable<Device>, DeviceRepositoryFailResponse>> ReadReadyAndSendingAsync( CancellationToken cancellationToken = default );
		...
		Task<RepositoryResponse<Device, DeviceRepositoryFailResponse>> ReadAsync( string hostname, HardwareType type, CancellationToken cancellationToken = default );
